...
public class Worker implements Runnable{
	...
	private final Lab1.Orange.State[] STATES = new Lab1.Orange.State[]
				{Lab1.Orange.State.Fetched, 
				 Lab1.Orange.State.Peeled, 
				 Lab1.Orange.State.Squeezed, 
				 Lab1.Orange.State.Bottled, 
